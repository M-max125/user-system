...
<head>
    ...
    <title><?= ucfirst(basename($_SERVER['PHP_SELF'],'.php'));?> |MCode League</title><!-- Dinamically display the title-->
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  <!-- Brand -->
  <a class="navbar-brand" href="index.php"><i class="fas fa-code fa-lg"></i>&nbsp;&nbsp;MCode League</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav ml-auto"> <!-- ml-auto brings the links to the left side of the nav-->
      <li class="nav-item">
        <a class="nav-link <?= (basename($_SERVER['PHP_SELF']) == "home.php")? "active":"";?>" 
        href="home.php"><i class="fas fa-home"></i>&nbsp;Home</a>
        <!-- Giving dinamically the active class to the link, using the ternary operator-->
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        href="notifications.php"><i class="fas fa-bell"></i>&nbsp;Notifications&nbsp;<span id="checkNotification"></span></a>
      </li>
