        ...
        <div class="col-lg-10">
            <div class="card rounded-0 mt-3 border-primary">
                ...
                <div class="card-body">
                    ...
                    <!-- Profile Tab Content-->
                        <div class="tab-pane container active" id="profile"><!-- This id is triggered from the anchor tag-->
                        <div id="verifyEmailAlert"></div>
                            <div class="card-deck">
                                ...
                                <div class="card border-primary align-self-center">
                                    ...
                                    <?php if(!$cphoto): ?>
                                    <img src="assets/images/avatar.jpeg" class="img-thumbnail img-fluid" width="408px">
                                    <?php else:?>
                          ...
                          <div class="tab-pane container fade" id="editProfile">
                            ...
                            <div class="card border-danger">
                                ...
                                id="profile-update-form">
                                    ...
                                    <input type="tel" name="phone" value="<?= $cphone;?>" class="form-control" id="phone" placeholder="Phone">
                                    </div>
                           ...
                           <!-- Edit Profile Tab Content End-->
                            ...
                            <div id="changepassAlert"></div>
                                <div class="card-deck">
                                    ...
                                    <img src="assets/images/keypass.jpeg" class="img-thumbnail img-fluid" width="408px">
                                    </div>
                                </div>
                            </div>
